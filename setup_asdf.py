...
def backup_and_symlink(source: str, dest: str, backup: str) -> None:
    ...
    logging.info(f"Creating symlink from {source} to {dest}")
    os.symlink(os.path.abspath(source), dest)

# Backup and symlink .tool-versions file
backup_and_symlink(tool_versions_file, dest_tool_versions_file, original_dir)
